...
/**
 * The RestExceptionHandler class will handle the exceptions, it must extend from Spring Boot’s
 * ResponseEntityExceptionHandler that already provides some basic handling of Spring MVC
 * exceptions, so we can continue adding handlers for new exceptions while improving the existing
 * ones.
 */
